...
- If the script's output contains `Upcoming motorcycle road-test slots`, POSTs the output as a push notification to `https://ntfy.sh/tw_moto_exams`. No-slot runs stay silent — the GH Actions log still has the full output for debugging.
